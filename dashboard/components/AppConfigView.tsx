           ...
           <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {aiModels.map(model => (
                ...
                >
                  ...
                  {(model.id.includes('local') || model.id.includes('qwen') || model.id.includes('cloud')) && !model.id.startsWith('gemini') && !model.id.includes('/') && <div className="text-[8px] mt-1 opacity-60 font-bold relative z-10">OLLAMA HOST</div>}
                  {model.id.includes('/') && <div className="text-[8px] mt-1 opacity-60 font-bold relative z-10 text-cyan-400">OPENROUTER API</div>}
